	...
	if (spollersArray.length > 0) {
		...
		function setSpollerAction(e) {
			...
			if (el.hasAttribute('data-spoller') || el.closest('[data-spoller]')) {
				...
				const spollerBody = spollerTitle.closest('[data-spollerWrapper]');
				...
				if (!spollersBlock.querySelectorAll('._slide').length) {
					...
					spollerBody.classList.toggle('_spoller-activeWrapper');
		...
		function hideSpollersBody(spollersBlock) {
			...
			const spollerActiveWrapper = spollersBlock.querySelector('[data-spollerWrapper]._spoller-activeWrapper');
			if (spollerActiveTitle) {
				spollerActiveTitle.classList.remove('_spoller-active');
				spollerActiveWrapper.classList.remove('_spoller-activeWrapper');
